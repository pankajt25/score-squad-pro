    ...
    <div className="min-h-[calc(100vh-56px)] flex items-center justify-center p-4 bg-field">
      <div className="w-full max-w-md slide-up">
        <div className="text-center mb-6">
          <h2 className="text-2xl font-display text-foreground tracking-tight">Enter Players</h2>
        ...
        {/* Team tabs */}
        <div className="flex gap-1 mb-4 p-1 bg-muted/50 rounded-lg border border-border">
          <button
        ...
        <div className="glass-card rounded-xl p-4 space-y-2 max-h-[55vh] overflow-y-auto">
            ...
            {currentPlayers.map((player, i) => (
              <div key={i} className="flex items-center gap-2.5 group">
                ...
                <Input
                  ...
                  className="bg-muted/20 border-border/50 text-sm h-10 rounded-lg focus:border-primary/50 focus:bg-muted/30 transition-all"
                />
              </div>
            ))}
          </div>
        ...
        <Button
          ...
          className="w-full mt-4 bg-primary text-primary-foreground hover:bg-primary/90 font-bold h-12 rounded-xl shadow-lg transition-all duration-200 active:scale-[0.98]"
        >
          Proceed to Toss →
        </Button>
      </div>
